...
const TestimonialCard: React.FC<TestimonialCardProps> = ({ testimonial: t, index: i, prefersReducedMotion }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-sm text-gray-600 leading-relaxed flex-1 mb-4">&ldquo;{t.quote}&rdquo;</p>
